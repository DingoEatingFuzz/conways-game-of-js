// Mostly copy-pasted from https://github.com/andrewrk/node-perlin-noise like a barbarian 
(function(global) {

global.generatePerlinNoise = function(width, height, options) {
  options = options || {};
...
global.generateWhiteNoise = function(width, height) {
  var noise = new Array(width * height);
